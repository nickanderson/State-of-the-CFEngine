...
\label{sec:org208e336}
\subsection*{Core}
\label{sec:orgf49e802}
\subsubsection*{\texttt{with} attribute}
\label{sec:orgb8c9f87}
...
\end{verbatim}
\captionof{figure}{\label{org8c6538b}
With attribute usage example policy}

\subsubsection*{\texttt{with} attribute}
\label{sec:org6a692d7}
...
\subsubsection*{Inventory API}
\label{sec:org53ee4b2}

\#+BEGIN\(_{\text{SRC}}\) json
\{
    "data": [
        \{
            "header": [
