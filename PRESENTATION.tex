...
\label{sec:orgf16de7d}
\subsection*{Core}
\label{sec:org7999a59}
\subsubsection*{\texttt{with} attribute}
\label{sec:orgd5f5de0}
...
\end{verbatim}
\captionof{figure}{\label{orgb5e1b68}
With attribute usage example policy}

\subsubsection*{\texttt{with} attribute}
\label{sec:org1a6f1c2}
